...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'folder-icon-generator',
    num: '05',
    title: 'Folder Icon Generator',
    tag: 'Web · Image Tool',
    year: '2025',
    role: 'Designer & Engineer',
    timeline: 'Side project',
    swatch: 'var(--red)',
    lede: 'A browser-based tool that turns any image into a Windows or macOS folder icon — drag, drop, export.',
    body: "Folio takes a PNG / JPG / WebP up to 8 MB and lets you live-edit placement with scale, rotation, opacity, and blend modes against two folder shapes and four visual styles. Three export modes: single PNG, dual-orientation ZIP, or a portable Windows folder package with embedded icons and a desktop.ini that survives the folder being moved. All client-side — no backend, no accounts. IndexedDB-backed project history, 50 levels of undo / redo, full keyboard shortcuts.",
    stack: ['TypeScript', 'Expo SDK 54', 'React Native Web', 'Expo Router', 'Zustand', 'IndexedDB', 'JSZip', 'png2icons'],
    span: 'half',
    shape: 'wave',
    link: 'github.com/Hale17OT/Folder-Icon-Generator',
    href: 'https://github.com/Hale17OT/Folder-Icon-Generator',
  },
  {
    id: 'eaglepoint',
    num: '06',
